...
# write_csv(final_df,"data/generated_data/analysis_data/final_df.csv")
# write_csv(final_wide,"data/generated_data/analysis_data/final_wide.csv")
...
ggsave(plot=f1,filename="figures/main_text/figure1.eps", height = 4.36,width = 6.5,scale = 1.5)
...
ggsave(plot=f2,filename="figures/main_text/figure2.eps", height = 2.39,width = 6.5,scale = 1.5)
...
ggsave(plot=f3,filename="figures/main_text/figure3.eps", height = 4.22,width = 6.5,scale = 1.5)
...
ggsave(plot=f4,filename="figures/main_text/figure4.eps", height = 2.89,width = 6.09,scale = 1.7)
...
ggsave(plot=fs1,filename="figures/supplement/supp_figure1.eps", height = 3.86,width = 6.5,scale = 1.2)

ggsave(plot=fs1,filename="figures/supplement/supp_figure1.tiff", height = 3.86,width = 6.5,scale = 1.2)
...
ggsave(plot=fs2,filename="figures/supplement/supp_figure2.png", height = 2.4,width = 6.5,scale = 2)
ggsave(plot=fs2,filename="figures/supplement/supp_figure2.tiff", height = 2.4,width = 6.5,scale = 2)
ggsave(plot=fs2,filename="figures/supplement/supp_figure2.eps", height = 2.4,width = 6.5,scale = 2)
...
ggsave(plot=fs3,filename="figures/supplement/supp_figure3.png", height = 4.22,width = 6.5,scale = 1.5)
ggsave(plot=fs3,filename="figures/supplement/supp_figure3.tiff", height = 4.22,width = 6.5,scale = 1.5)
ggsave(plot=fs3,filename="figures/supplement/supp_figure3.eps", height = 4.22,width = 6.5,scale = 1.5)
...
ggsave(plot=fs4,filename="figures/supplement/supp_figure4.png", height = 2.89,width = 6.09,scale =2)
ggsave(plot=fs4,filename="figures/supplement/supp_figure4.tiff", height = 2.89,width = 6.09,scale = 2)
ggsave(plot=fs4,filename="figures/supplement/supp_figure4.eps", height = 2.89,width = 6.09,scale = 2)
