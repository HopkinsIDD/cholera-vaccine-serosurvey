...
#         ggplot(aes(col=factor(end_window),
#                    y=seropos,x=day))+
#         geom_line() +
#         facet_grid(.~cohort,scales="free_x",space="free_x")+
#         theme_cowplot()+
#         scale_x_continuous("Infection Window (Days)",breaks=seq(0,365,28))+
#         scale_y_continuous("False Positivity Rate",limits=c(0,0.4))+
#         geom_hline(yintercept = 0.05,lty=2)+
#         theme(legend.position = "bottom")
...
mds_obj <- read_rds("data/generated_data/analysis_objects/mds_obj.rds")
...
```{r f3-loocv, eval=TRUE,fig.width=6,fig.height=10}
...
```{r f4-three-class, eval=FALSE,fig.width=5.5,fig.height=9}
